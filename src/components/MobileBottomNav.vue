...
<template>
  <nav 
    class="fixed bottom-3 left-3 right-3 z-40 bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl border border-white/30 dark:border-slate-800/60 shadow-2xl rounded-2xl p-1.5 flex items-center justify-around max-w-lg mx-auto transition-all duration-300"
  ...
  >
    ...
    <!-- 4. المشاريع (Projects Sheet Trigger) -->
    <button 
