  ...
  <div class="max-w-6xl mx-auto p-2 sm:p-3 relative overflow-x-hidden" @touchstart="onTouchStart" @touchmove="onTouchMove" @touchend="onTouchEnd">
      ...
      <form @submit.prevent="submitNewHabit" class="space-y-4 sm:space-y-5">
        ...
        <div>
          ...
          <input 
            ...
            required
            class="w-full px-4 py-3 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-850 text-slate-900 dark:text-white text-sm font-bold focus:ring-2 focus:ring-violet-500 outline-none"
          />
        </div>
    ...
    >
      <div v-if="activeHabitForStats" class="text-center relative">
        ...
        <div class="bg-gradient-to-b from-slate-50 to-amber-50/40 dark:from-slate-850 dark:to-amber-950/20 rounded-3xl p-5 border border-amber-200/50 dark:border-amber-900/30 mb-6 shadow-inner relative overflow-hidden">
        ...
        <div class="flex items-center justify-around bg-slate-50 dark:bg-slate-850 p-4 rounded-2xl border border-slate-200/60 dark:border-slate-800 mb-6">
    ...
    >
      <div v-if="quickDetailHabit" class="space-y-5 text-right">
        ...
        <div class="flex items-center gap-3.5 bg-slate-50 dark:bg-slate-850 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800">
          <div 
            :class="[
        ...
        <div class="bg-slate-50 dark:bg-slate-850 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-3">
        ...
        <!-- Notes Preview -->
        <div class="bg-slate-50 dark:bg-slate-850 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-2">
          <div class="flex items-center justify-between">
            <h5 class="text-xs font-extrabold text-slate-800 dark:text-slate-200 flex items-center gap-1.5">
